...
exports.Stakeholder = {
    ...
    GetStakeholder: function (username, name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    AddStakeholder: function (name, description, type) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Database_1.Data.Execute("insert into stakeholder (name, description, account_id) \n                values ($1, $2, $3);")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=stakeholder_data.js.map