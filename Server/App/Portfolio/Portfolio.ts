...
portfolio_api.get('/analysis', async (req, res) => {
...
portfolio_api.post('/parent', async (req, res) => {
...
portfolio_api.post('/portfolio/project/delete', async (req, res) => {
...
portfolio_api.get('/project/:name', async (req, res) => {
    let title = "error";
    let data = {};
    try {
...
portfolio_api.get('/project/category/:category', async (req, res) => {
...
portfolio_api.post('/project/category', async (req, res) => {
    let project = await Project.Get(req.body['project'], req.session['username']);
    if (project != null) {
...
portfolio_api.post('/project/update', async (req, res) => {
    try {
...
portfolio_api.post('/delete', async (req, res) => {
...
portfolio_api.get('/stakeholder', async (req, res) => {
    RenderTemplate(req, res, 'Stakeholders', 'portfolio/stakeholder.ejs')
})

portfolio_api.get('/resources', async (req, res) => {
