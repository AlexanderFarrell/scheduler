...
var auth_data_1 = require("./auth_data");
var auth_middleware_1 = require("./auth_middleware");
...
exports.auth_api.get('/account', function (req, res) {
    (0, auth_middleware_1.IsLoggedIn)(req, res, function () {
        (0, ServerHelper_1.RenderTemplate)(req, res, "Account", "auth/account.ejs");
    });
});
...
exports.auth_api.post('/create', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!auth_data_1.Account.creation_enabled) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_data_1.Account.create(username, password, first_name, last_name)];
            case 2:
                _a.sent();
                // @ts-ignore
...
exports.auth_api.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_data_1.Account.login(username, password)];
            case 2:
                data = _a.sent();
                // @ts-ignore
                req.session.username = username;
