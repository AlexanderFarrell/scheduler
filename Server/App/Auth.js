            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_1 = _a.sent();
                        console.log(e_1);
                        (0, ServerHelper_1.RenderTemplate)(res, 'Login', 'login.ejs', { m: e_1.message });
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.trys.push([5, 7, , 8]);
                        return [4 /*yield*/, Database_1.Data.Pool.query("insert into account (username, hash) VALUES ($1, $2)", [username, hash])];
                    case 6:
                        _a.sent();
